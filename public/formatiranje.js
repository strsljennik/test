...
// Funkcija za ažuriranje boje samo jednog gosta
function updateGuestColor(guest) {
    guest.style.color = currentColor; // Promena boje samo za odabranog gosta
}

// Dodaj event listener za svakog gosta
document.querySelectorAll('#guestList .guest').forEach(guest => {
    guest.addEventListener('click', function() {
        updateGuestColor(guest); // Menja boju samo za odabranog gosta
    });
});
