...
socket.on('newGuest', function (nickname) {
    ...
    // Dodajemo opciju da gost može izabrati boju
    ...
    colorPickerButton.addEventListener('input', function() {
        newGuest.style.color = this.value;
    });

    // Dodajemo dugme za bold i italic
    const boldButton = document.createElement('button');
    boldButton.textContent = 'B';
    boldButton.addEventListener('click', function() {
        newGuest.style.fontWeight = newGuest.style.fontWeight === 'bold' ? 'normal' : 'bold';
    });

    const italicButton = document.createElement('button');
    italicButton.textContent = 'I';
    italicButton.addEventListener('click', function() {
        newGuest.style.fontStyle = newGuest.style.fontStyle === 'italic' ? 'normal' : 'italic';
    });

    newGuest.appendChild(colorPickerButton);
    newGuest.appendChild(boldButton);
    newGuest.appendChild(italicButton);
...
socket.on('updateGuestList', function (users) {
    ...
    users.forEach(user => {
        ...
        // Dodajemo opciju za promenu boje
        const colorPickerButton = document.createElement('input');
        colorPickerButton.type = 'color';
        colorPickerButton.classList.add('colorPicker');
        colorPickerButton.addEventListener('input', function() {
